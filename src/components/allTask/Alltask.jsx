...
const Completed = () => {
  ...
  const CompletedTask = useSelector((state) => state.tasks?.Completed || []);
  const [showModal, setShowModal] = useState(false);
  const [selectedTask, setSelectedTask] = useState(null);
  const CompletedTaskArray = Object.values(CompletedTask);
  ...
  return (
    <div className="container-fluid ">
      ...
      {CompletedTaskArray.length > 0 ? (
        <div className="p-5 row justify-content-center">
          {CompletedTaskArray.map((item, i) => (
            <div
              key={i.toString()}
            ...
            >
              <div className="shadow border-0 rounded-4 mb-3 pb-2">
                ...
                <div className=" m-3 d-flex gap-3 justify-content-end align-items-center">
                  ...
                  <div>
                    <h6 className="fw-bold" style={{ color: "#3F7D58" }}>
